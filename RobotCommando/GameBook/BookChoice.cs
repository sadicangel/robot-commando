...
{
    [XmlAttribute("to")] public int To { get; set; }

    [XmlAttribute("showWhenDisabled")] public bool ShowWhenDisabled { get; set; }

    [XmlElement("text")] public string Text { get; set; } = string.Empty;

    [XmlElement("condition")] public ConditionExpression<GameState>? Condition { get; set; }

    [XmlElement("effect")] public EffectExpression<GameState>? Effect { get; set; }
